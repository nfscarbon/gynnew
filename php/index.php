        ...
        <div class="about-fitness-area" id="about">
            <div class="container-fluid">
                ...
                <div class="about-fitness-right padding-space">
                    <p><strong>Modern Fitness Gym</strong> was founded by <strong>Nitin Diwakar</strong> and <strong>Ratna Deep Verma</strong> in 2019, with great zeal, gusto and gaiety. Both of them have played at international level and won accolades across the globe. During one of their tours, they realised they could contribute towards the upliftment of fitness level. Inspired by various programs conducted overseas for the betterment of health conditions, they both decided to take a step and perk up health and fitness awareness.</p>
					...
					<p>The pair decided the name-<strong>"Modern Fitness Gym"</strong> a decade ago.</p>
                    ...
                    <p>Located in one of the posh areas of Delhi. </p>
                ...
                <div  style="position: relative; height: 329px;">
                    <div class="col-md-4" style="position: absolute; left: 0px; top: 0px;">
                        <div class="gallery-boxeas">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/8lQzkwqhKTk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
                        </div>
                    </div>
                    ...
                    <div style="position: absolute; left: 380px; top: 0px;">
                        <div class="gallery-boxeas">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/CLccU7tk7es" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
                        </div>
                    </div>

                    <div style="position: absolute; left: 760px; top: 0px;">
                        <div class="gallery-boxeas">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/XoZMc6X7pbU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
                        </div>
                    </div>
                ...
                <div class="div-box">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hvr-float-shadow">
                        <div class="price-table-box">
                            ...
                            <a class="custom-button" data-title="Become A Member" href="user/login.php">Join Us</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hvr-float-shadow">
                        <div class="price-table-box">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-1">
                        <div class="copy-right">
                            <p>© Copyrights <strong>Modern Fiteness Gym</strong> 2019. All rights reserved. Designed and Developed by<a href="#" target="_blank" title="Nitin Diwakar"> Nitin Diwakar
											</a></p>
                        </div>
                    </div>
                </div>
